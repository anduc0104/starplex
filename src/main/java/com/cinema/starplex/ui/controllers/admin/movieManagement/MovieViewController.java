...
public class MovieViewController {
    ...
    public void initialize() throws SQLException {
        ...
        genreColumn.setCellValueFactory(cellData -> new SimpleObjectProperty<>(
                cellData.getValue().getGenres() != null ?
    ...
    private void handleEdit(Movie movie) {
        ...
        if (loader != null) {
            ...
            System.err.println("Could not load edit-movie.fxml");
        }
    }
    ...
    private void handleDelete(Movie movie) throws SQLException {
        ...
        if (result.isPresent() && result.get() == ButtonType.OK) {
            ...
            // Xóa các bản ghi liên quan trong bảng movie_movie_genres
            movieMovieGenreDao.delete(idToDelete); // Thay đổi ở đây

            // Sau đó xóa bản ghi trong bảng movies
    ...
    public void handleAdd(ActionEvent event) {
        ...
        if (loader != null) {
            ...
            System.err.println("Failed to load add-movie.fxml");
        }
    }
