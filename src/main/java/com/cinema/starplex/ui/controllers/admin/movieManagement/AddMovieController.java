...
public class AddMovieController {
    ...
    private void handleSave(ActionEvent event) {
        ...
        if (title.isEmpty() || director.isEmpty() || duration.isEmpty() || releaseDate == null || selectedGenres.isEmpty()) {
            showAlert(Alert.AlertType.ERROR, "Error", "Please fill in all required fields.");
            return;
        }

        String sql = "INSERT INTO movies (title, directors, actors, duration, release_date, description, images) VALUES (?, ?, ?, ?, ?, ?, ?)";
        ...
        try (Connection conn = DatabaseConnection.getConn();
            ...
            stmt.setString(5, releaseDate.toString());
    ...
    private void insertMovieGenres(Connection conn, int movieId, List<String> genres) throws SQLException {
        String sqlInsertMovieType = "INSERT INTO movie_type (movie_id, genre_id) VALUES (?, ?)";
